...
import { TeacherScreen, Screen, CustomModule, UserRole } from '../../types/types';
...
const TeacherBottomNav: React.FC<TeacherBottomNavProps> = ({ activeScreen, setActiveScreen, enabledModules, customModules }) => {
  const allStandardNavItems = [
    ...
    { screen: TeacherScreen.AllForAll, label: 'All for All', iconName: 'color-palette-outline' },
      ...
      <div className="relative" style={{ height: '70px' }}>
        ...
        >
          <defs>
            ...
            <filter id="shadowTeacher" x="-50%" y="-50%" width="200%" height="200%">
