            ...
            <div className="p-2 space-y-4">
                ...
                <div className="space-y-3">
                    {MOCK_STUDENTS.map((student, index) => (
                        <div 
                            key={student.id} 
                            className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center space-x-4 animate-stagger"
                        ...
                        >
                            ...
                            <div className="text-right">
                                 <span className="px-3 py-1 text-xs font-semibold text-sky-700 bg-sky-100 dark:bg-sky-900/50 rounded-full">
                                    Nivel {student.level}
                                </span>
                            </div>
                        </div>
