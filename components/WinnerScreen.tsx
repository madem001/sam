...
const WinnerScreen: React.FC<WinnerScreenProps> = ({ points, onContinue }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-gradient-to-br from-green-400 to-teal-500 dark:to-teal-600 text-white">
